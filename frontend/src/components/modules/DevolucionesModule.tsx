...
export function DevolucionesModule() {
  ...
  const handleSave = () => {
    ...
    const productosSeleccionados = productosDevolver.filter(
      (p) => p.selected && p.cantidadADevolver > 0,
    );
    ...
    const excedeCompra = productosDevolver.some(
      (p) => p.selected && p.cantidadADevolver > p.cantidadComprada,
    );
    if (excedeCompra) {
  ...
  const handleChangeEstado = (newEstado: string) => {
    ...
    if (
      (newEstado === "aprobada" || newEstado === "rechazada") &&
      !motivoDecision.trim()
    ) {
  ...
  const handleAnularDevolucion = () => {
    ...
    if (!motivoAnulacion.trim() || motivoAnulacion.trim().length < 5) {
      alert(
        "Debe ingresar un motivo de anulación válido (mínimo 5 caracteres)",
      );
      return;
    }
  ...
  const isFormValid = () => {
    return (
      formData.ventaId.trim().length > 0 && formData.motivo.trim().length >= 5
    );
  };
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="p-4 border-b border-border space-y-4">
            ...
            <div>
              <p
                ...
                style={{ fontSize: "14px" }}
              >
                Mostrando {filteredDevoluciones.length} de {devoluciones.length}{" "}
                devoluciones
              </p>
            </div>
          </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-border hover:bg-transparent">
                ...
                <TableHead className="text-foreground-secondary text-right">
                  Acciones
                </TableHead>
              </TableRow>
            </TableHeader>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <div className="flex flex-col gap-1">
                            <div
                              className={`inline-flex items-center px-2.5 py-1 rounded-full ${getEstadoColor(devolucion.estado).bg}`}
                            >
                              <span
                                className={`${getEstadoColor(devolucion.estado).text}`}
                            ...
                            {devolucion.motivoDecision && (
                              <span
                                className="text-foreground-secondary"
                                style={{ fontSize: "11px" }}
                                title={devolucion.motivoDecision}
                              >
                                {devolucion.motivoDecision.length > 30
                                  ? devolucion.motivoDecision.slice(0, 30) +
                                    "..."
                                  : devolucion.motivoDecision}
                              </span>
                            )}
                            {devolucion.motivoAnulacion && (
                              <span
                                ...
                                style={{ fontSize: "11px" }}
                                title={devolucion.motivoAnulacion}
                              >
                                {devolucion.motivoAnulacion.length > 30
                                  ? devolucion.motivoAnulacion.slice(0, 30) +
                                    "..."
                                  : devolucion.motivoAnulacion}
                              </span>
                            )}
        ...
        <DialogContent className="bg-card border-border max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              Formulario para registrar una nueva devolución de productos
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(
                  value: "Procesada" | "Pendiente" | "Rechazada",
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-foreground">
                        {clientes.find((c) => c.id === ventaData.clienteId)
                          ?.nombre || "N/A"}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                              ...
                              <div className="mt-3 pl-10 flex items-center gap-4">
                                <div className="flex-1">
                                  ...
                                  <input
                                    ...
                                    max={item.cantidad}
                                    value={
                                      productosDevolver[index]
                                        ?.cantidadADevolver || ""
                                    }
                                    onChange={(e) =>
                                      handleCantidadDevolucion(
                                        index,
                                ...
                                {productosDevolver[index]?.cantidadADevolver >
                                  0 && (
                  ...
                  <p
                    ...
                    style={{ fontSize: "12px" }}
                  >
                    Seleccione uno o más productos y especifique la cantidad a
                    devolver
                  </p>
                </div>

                {productosDevolver.some(
                  (p) => p.selected && p.cantidadADevolver > 0,
                ) && (
            ...
            <div className="space-y-6 py-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <div
                    className={`inline-flex items-center px-2.5 py-1 rounded-full ${getEstadoColor(selectedDevolucion.estado).bg}`}
                  >
                    <span
                      className={`${getEstadoColor(selectedDevolucion.estado).text}`}
                      style={{ fontSize: "12px", fontWeight: 500 }}
                    >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-foreground">
                    {clientes.find((c) => c.id === selectedDevolucion.clienteId)
                      ?.nombre || "N/A"}
                  </p>
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-foreground">
                    {selectedDevolucion.ventaId.slice(0, 8)}
                  </p>
                </div>
                <div className="space-y-1">
                  <p
      ...
      <Dialog open={pdfDialogOpen} onOpenChange={setPdfDialogOpen}>
        <DialogContent className="bg-card border-border max-w-3xl max-h-[90vh]">
          <DialogHeader>
            <DialogTitle className="text-foreground">
              Comprobante de Devolución - PDF
            </DialogTitle>
            <DialogDescription className="sr-only">
              Vista de impresión del comprobante de devolución
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-surface p-4 rounded-lg">
                  ...
                  <div className="space-y-1">
                    <p className="text-foreground">
                      {clientes.find(
                        (c) => c.id === selectedDevolucion.clienteId,
                      )?.nombre || "N/A"}
                    </p>
                    <p
                      className="text-foreground-secondary"
                    ...
                    return (
                      <div
                        ...
                        className={`grid grid-cols-12 gap-4 px-4 py-3 ${
                          i !== selectedDevolucion.productos.length - 1
                            ? "border-b border-border"
                            : ""
                        }`}
                      >
                        <p className="col-span-8 text-foreground">
                          {producto?.nombre || "N/A"}
                        </p>
                        <p className="col-span-4 text-right text-foreground-secondary">
                          {p.cantidad}
                        </p>
                      </div>
                    );
      ...
      <Dialog open={estadoDialogOpen} onOpenChange={setEstadoDialogOpen}>
        <DialogContent className="bg-card border-border">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              Formulario para actualizar el estado de la devolución
            </DialogDescription>
          </DialogHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                      <p
                        ...
                        style={{ fontSize: "12px" }}
                      >
                        La devolución pasará a revisión para evaluar la
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                        <p
                          ...
                          style={{ fontSize: "12px" }}
                        >
                          <strong className="text-foreground">Aprobar:</strong>{" "}
                          Los productos serán devueltos al inventario.
                          <br />
                          <strong className="text-foreground">
                            Rechazar:
                          </strong>{" "}
                          La devolución será rechazada sin afectar el
                          inventario.
                        </p>
                      </div>
                    </div>
      ...
      <Dialog open={anularDialogOpen} onOpenChange={setAnularDialogOpen}>
        <DialogContent className="bg-card border-border">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              Formulario para anular una devolución activa
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="bg-danger hover:bg-danger/90 text-background"
              disabled={
                !motivoAnulacion.trim() || motivoAnulacion.trim().length < 5
              }
            >
              Anular Devolución
            </Button>

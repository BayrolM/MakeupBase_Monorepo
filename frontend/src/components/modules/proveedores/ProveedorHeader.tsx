          ...
          <div className="relative flex flex-wrap gap-6 justify-between items-center z-10">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold tracking-tight luxury-text-cream">Proveedores</h1>
                  <p className="text-sm mt-0.5 luxury-text-cream">Gestión de aliados comerciales y suministros</p>
                </div>
              </div>
            </div>
            {isAdmin && (
